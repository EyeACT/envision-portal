...
const { data, error } = await useFetch(
  `/api/studies/${studyId}/datasets/${datasetId}/metadata/about`,
  {},
);
...
async function onSubmit(event: FormSubmitEvent<typeof state>) {
  ...
  await $fetch(`/api/studies/${studyId}/datasets/${datasetId}/metadata/about`, {
    body: b,
    method: "PUT",
  })
    .then((res) => {
  ...
  <div>
    <UBreadcrumb
      ...
      :items="[
        ...
        {
          label: 'About',
          to: `/app/study/${studyId}/datasets/${datasetId}/metadata/about`,
        },
      ]"
    />
