...
const { data, error } = await useFetch(
  `/api/studies/${studyId}/datasets/${datasetId}/metadata/team`,
  {},
);
...
async function onSubmit(event: FormSubmitEvent<typeof state>) {
  ...
  await $fetch(`/api/studies/${studyId}/datasets/${datasetId}/metadata/team`, {
    body: b,
    method: "PUT",
  })
    .then((res) => {
  ...
  <div>
    <UBreadcrumb
      ...
      :items="[
        ...
        {
          label: 'Team',
          to: `/app/study/${studyId}/datasets/${datasetId}/metadata/team`,
        },
      ]"
    />
