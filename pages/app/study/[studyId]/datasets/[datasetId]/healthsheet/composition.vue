...
const { data, error } = await useFetch(
  `/api/studies/${studyId}/datasets/${datasetId}/healthsheet/composition`,
  {},
);
    ...
    <UBreadcrumb
      ...
      :items="[
        ...
        },
        {
          ...
          to: `/app/study/${studyId}/datasets/${datasetId}/healthsheet/composition`,
        },
      ]"
    />
    ...
    <div class="flex w-full flex-col gap-6 pb-5">
      ...
      >
        <div class="flex w-full items-center justify-between gap-3">
          <h1 class="font-bold text-gray-900 dark:text-white">Composition</h1>
        </div>
