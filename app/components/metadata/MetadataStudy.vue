...
const isStudyMetadataEmpty = computed(() => {
...
<template>
  <div>
    <p
      v-if="isStudyMetadataEmpty"
      class="my-20 flex justify-center font-semibold text-gray-400 italic"
    >
      No Study Metadata information available for this dataset.
    </p>

    <div class="h-auto space-y-6" v-else>
      <CardCollapsibleContent title="Design">
        <div class="h-auto space-y-6">
          ...
          <div v-if="props.metadata.designModule.numberGroupsCohorts">
            ...
            <p>
              {{ props.metadata.designModule?.numberGroupsCohorts || "N/A" }}
            </p>
          </div>
          ...
          >
            ...
            <div v-if="props.metadata.designModule.designInfo">
              ...
              <div>
                ...
                <p>
                  {{
                    props.metadata.designModule.designInfo
          ...
          >
            ...
            <div v-if="props.metadata.designModule?.bioSpec?.bioSpecRetention">
              ...
              <p>
                {{
                  props.metadata.designModule?.bioSpec.bioSpecDescription ||
                  "N/A"
                }}
              </p>
            </div>
            ...
            <div
              v-if="props.metadata.designModule?.bioSpec?.bioSpecDescription"
            >
      ...
      <CardCollapsibleContent title="Eligibility">
        <div class="space-y-6">
          ...
          <div>
            ...
            <p>
              {{ props.metadata.eligibilityCriteria?.genderBased || "N/A" }}
            </p>
          </div>
      ...
      <CardCollapsibleContent title="Identification Information">
        <div class="space-y-6">
          ...
          <div>
            ...
            <p>
              {{
                props.metadata.identificationModule.orgStudyIdInfo
                  .orgStudyIdType
              }}
            </p>
          </div>
      ...
      <CardCollapsibleContent title="Oversight">
        <div class="space-y-6">
          ...
          <div>
            ...
            <p>
              {{ props.metadata.oversightModule?.oversightHasDMC || "N/A" }}
            </p>
          </div>
        </div>
      </CardCollapsibleContent>
