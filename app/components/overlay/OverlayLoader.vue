...
<template>
  ...
  <div v-if="overlay && hasContent" :class="['relative', props.class]">
    <div
      :class="['transition-opacity', props.loading && 'pointer-events-none']"
    >
      <slot />
    </div>
  ...
  <div v-else :class="['flex items-center justify-center', props.class]">
    <Icon
      v-if="props.loading"
      name="svg-spinners:blocks-wave"
      :class="
