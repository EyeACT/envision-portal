    ...
    <div ref="timelineRef" class="relative z-0 mx-auto max-w-7xl pb-20">
      <div v-for="(item, index) in props.items" :key="item.id + index"
        ...
        <div
          ...
          <h3 class="hidden text-xl font-bold text-neutral-500 md:block md:pl-20 md:text-5xl dark:text-neutral-500">
            {{ item.label }}
          </h3>
        </div>
...
watch(height, (newHeight) => {
  heightTransform = useTransform(scrollYProgress as any, [0, 1], [0, newHeight]);
});
</script>