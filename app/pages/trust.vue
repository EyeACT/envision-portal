      ...
      <div class="prose prose-lg max-w-none">
        <section id="summary" class="mb-10">
          ...
          <p class="mb-4 text-lg text-gray-700">
            ...
            streamline the management and sharing of eye imaging data. It helps
            researchers manage, curate, and share their data following the FAIR
            principles so that datasets are ready for AI-driven analysis and
          ...
          <p class="mb-8 text-gray-600">
            ...
            <NuxtLink
              to="https://www.nature.com/articles/s41597-020-0486-7"
              target="_blank"
            ...
            <ul class="list-disc space-y-2 pl-6">
              ...
              <li>
                ...
                <NuxtLink
                  ...
                  class="text-blue-700 underline hover:text-blue-900"
                >
                  <span>Envision Portal documentation</span>
                </NuxtLink>
              ...
              <li>
                ...
                Service uptime, response times, and planned maintenance are
                monitored and reported via our public status page, powered by
                Uptime Kuma, at
                <NuxtLink
                  to="https://status.envisionportal.org/"
                  target="_blank"
                  class="text-blue-700 underline hover:text-blue-900"
                >
                  <span>status.envisionportal.org</span>
                </NuxtLink>
                <span>.</span>
              </li>
            </ul>
        ...
        <section id="responsibility" class="mb-12">
          ...
          <p class="mb-4">
            We take responsibility for the stewardship of eye imaging datasets
            and associated metadata, including their quality, preservation, and
            appropriate use.
          </p>
          ...
          <div class="mb-4 border-l-4 border-green-400 bg-green-50 p-4">
            ...
            <ul class="list-disc space-y-2 pl-6">
              <li>
                ...
                OMOP, and structured clinical dataset models). Public examples
                of how we document complex datasets are available in metadata
                repositories such as our
                <NuxtLink
                  to="https://github.com/EyeACT/ADDF-dataset-metadata-files/tree/main/main/v1.0.0"
                  target="_blank"
                  class="text-blue-700 underline hover:text-blue-900"
                >
                  <span>metadata file examples</span>
                </NuxtLink>
                <span>.</span>
              </li>
              <li>
                ...
                Azure-backed object storage to support long-term preservation
                and disaster recovery. As the platform grows, we will continue
                to refine integrity monitoring and fixity checks.
              </li>
              <li>
                <strong>Access controls &amp; responsible reuse:</strong>
                Public and controlled datasets are clearly distinguished. For
                controlled datasets, access requests capture the requester’s
                name, affiliation, email, and reason for access, and are handled
          ...
          <div class="mb-4 border-l-4 border-purple-400 bg-purple-50 p-4">
            ...
            <ul class="list-disc space-y-2 pl-6">
              <li>
                ...
                <span>.</span> Each dataset overview page provides key metadata,
                access conditions, and a metrics section with usage indicators
                (e.g., views and downloads).
              </li>
              <li>
                <strong>Guided submission workflows:</strong>
                For invited contributors, Envision Portal offers guided
                workflows that support data standardization, de-identification,
                metadata completeness, and appropriate access controls, making
                it easier to share data that are responsibly reusable by the
                community.
              </li>
              <li>
                ...
                <span>.</span> Bugs and feature requests can be filed as GitHub
                issues at
                <NuxtLink
                  to="https://github.com/EyeACT/envision-portal/issues"
                  target="_blank"
                  class="text-blue-700 underline hover:text-blue-900"
                >
                  <span>github.com/EyeACT/envision-portal/issues</span>
                </NuxtLink>
                <span>.</span>
              </li>
              <li>
          ...
          <div class="mb-4 border-l-4 border-orange-400 bg-orange-50 p-4">
            ...
            <ul class="list-disc space-y-2 pl-6">
              <li>
                ...
                Envision Portal is developed by the FAIR Data Innovations Hub
                team as part of the Eye ACT study, in collaboration with the
                University of Washington and Kaiser Permanente Washington.
              </li>
              <li>
                <strong>Funding:</strong>
                Our contribution to Eye ACT is funded through a subaward from
                the National Institute on Aging (NIA) grant R01AG060942. Funding
                acknowledgements are included in project documentation and
                related materials.
              </li>
              <li>
                <strong>Long-term planning:</strong>
                Long-term access plans for datasets hosted in Envision Portal
                are developed in collaboration with our funding and
                institutional partners. As the platform matures, we will publish
                additional details on governance, risk management, and business
                continuity.
              </li>
              <li>
          ...
          <div class="mb-4 border-l-4 border-red-400 bg-red-50 p-4">
            ...
            <ul class="list-disc space-y-2 pl-6">
              <li>
                ...
                backed by PostgreSQL and Azure Data Lake for scalable storage.
                The platform is open-source and designed for extensibility, with
                ...
                <NuxtLink
                  ...
                  class="text-blue-700 underline hover:text-blue-900"
                >
                  <span>github.com/EyeACT/envision-portal</span>
                </NuxtLink>
                <span>.</span>
              </li>
              <li>
              ...
              <li>
                ...
                Technical architecture and repository operations are documented
                at
                <NuxtLink
                  to="https://docs.envision.io/"
                  target="_blank"
                  class="text-blue-700 underline hover:text-blue-900"
                >
                  <span>docs.envision.io</span>
                </NuxtLink>
                <span
                  >, with further details to be added as additional
                  functionality is introduced.</span
                >
              </li>
            </ul>
          </div>
        ...
        <section id="self-assessment" class="mb-12">
          ...
          <p class="mb-6">
            The table below provides a high-level self-assessment of how
            Envision Portal currently aligns with the TRUST Principles for
            Digital Repositories. It is intended as a living overview that will
            be updated as the platform evolves.
          </p>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border border-gray-300 px-4 py-3">
                    Platform purpose, scope, and current status are documented
                    on the About page; Terms of Use and Privacy Policy are
                    public; documentation is available at docs.envision.io; and
                    service status is reported via a public status page.
                  </td>
                </tr>
                <tr class="bg-gray-50">
                  <td class="border border-gray-300 px-4 py-3 font-medium">
                  ...
                  <td class="border border-gray-300 px-4 py-3">
                    FAIR-aligned curation practices, daily database snapshots
                    and backups in Azure object storage, clear separation of
                    public vs. controlled datasets, and dataset-level
                    documentation support responsible reuse.
                  </td>
                </tr>
                <tr>
                  <td class="border border-gray-300 px-4 py-3 font-medium">
                    User Focus: Repository services are designed around the
        ...
        <section id="references" class="mb-8">
          ...
          <div class="rounded-lg bg-gray-50 p-4">
            <p class="text-sm">
              ...
              J., Dillo, I. et al.
              <em>The TRUST Principles for digital repositories.</em> Sci Data
              7, 144 (2020).
              <NuxtLink
                to="https://doi.org/10.1038/s41597-020-0486-7"
                target="_blank"
                class="text-blue-600 underline hover:text-blue-800"
              >
                <span>https://doi.org/10.1038/s41597-020-0486-7</span>
              </NuxtLink>
            </p>
          </div>
        </section>
        ...
        <section id="questions-feedback" class="mb-12">
          <div class="rounded-lg border border-blue-200 bg-blue-100 p-6">
            ...
            <UButton class="" size="lg" type="button">
              ...
              <NuxtLink
                to="/contact"
                class="inline-flex items-center gap-2 text-white no-underline hover:no-underline"
              >
      ...
      <aside class="md:w-64 md:flex-shrink-0">
        ...
        <div class="mb-6 flex gap-2 overflow-x-auto md:hidden">
          <button
            ...
            :key="section.id"
            type="button"
            class="rounded-full px-3 py-2 text-xs whitespace-nowrap"
            :class="
              section.id === activeId
