...
const uiClasses = computed(() => ({
  ...
  header: `${contentCollapsed.value ? "border-none" : "bg-gray-100"} transition-colors duration-300 px-5 py-4 cursor-pointer hover:bg-gray-200 rounded-t-lg`,
...
<template>
  ...
  <UCard :ui="{ ...uiClasses }">
    <!-- Card Header -->
    <template #header>
      <div class="flex items-center justify-between" @click="toggleCollapse">
